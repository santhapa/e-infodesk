<?php
	...
	class ProcessModules
	{
        ...
        //Schedules process starts
          ...
          {
            $type=mysql_real_escape_string($_POST['schedule_viewType']);
          ...
          if(isset($_POST['userUpdate']))
          {
            ...
            $permAddress=mysql_real_escape_string($_POST['permAddress']);
            $tempAddress=mysql_real_escape_string($_POST['tempAddress']);
            $batch=mysql_real_escape_string($_POST['batch']);
            if($userType==2)
              $deptStudent=mysql_real_escape_string($_POST['departmentStudent']);
            else
              $deptStudent="";
            ...
            if($userType==3)
              $deptStaff=mysql_real_escape_string($_POST['departmentStaff']);
            else
              $deptStaff="";
            $jobPosition=mysql_real_escape_string($_POST['jobPosition']);
          ...
          if(isset($_POST['changeAccount']))
          {
            ...
            $repassword=mysql_real_escape_string(md5($_POST['repassword']));
...
//////////News and notices process
          ...
          if(isset($_POST['noticeUpdate']))
          {
            ...
            $id=mysql_real_escape_string($_POST['noticeID']);
            $orgAuthor=mysql_real_escape_string($_POST['orgAuthor']);
...
///////////Notes processes
      ...
      function viewSchedule($view)
      {
        ...
        $section="";
        if($view==1)
          $department=mysql_real_escape_string(strtoupper($_POST['schedule_dept']));
        
        if($view==2)
          $level=mysql_real_escape_string($_POST['schedule_level']);
        
        if($view==3)
        {
          $department=mysql_real_escape_string(strtoupper($_POST['schedule_dept']));
          $level=mysql_real_escape_string($_POST['schedule_level']);
          $section=mysql_real_escape_string(strtoupper($_POST['schedule_section']));
        }
...
////////Notice processes
        function noticeAdd()
        {
          ...
          $title=mysql_real_escape_string($_POST['notice_title']);
          $content= $_POST['notice_content'];
          $status= mysql_real_escape_string($_POST['notice_status']);
...
////////Notice processes
        function noteAdd()
        {
          ...
          $title=mysql_real_escape_string($_POST['note_title']);
